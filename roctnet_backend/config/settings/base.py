...
# roctnet/
APPS_DIR = ROOT_DIR / "roctnet"
REACT_APP_DIR = ROOT_DIR / "roctnet_client"
env = environ.Env()
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///roctnet")
}
...
LOCAL_APPS = [
    "roctnet.users.apps.UsersConfig",
    "roctnet.core.apps.CoreConfig",
    "roctnet.diagnosis.apps.DiagnosisConfig"
...
MIGRATION_MODULES = {"sites": "roctnet.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "roctnet.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "roctnet.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "roctnet.users.adapters.SocialAccountAdapter"
