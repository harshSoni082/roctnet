                        ...
                        this.state.show ? 
                            <div>
                                <Row className='banner' gutter={[64, 0]}>
                                    <Col span={24}>
                                        <div>
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <span style={banner_text_style} className="logo">
                                                oct-d
                                            </span>
                                        </div>
                                    </Col>
                                ...
                                <Row className='banner-text' gutter={[64, 0]}>
                                    <Col span={24}>
                                        <div>
                                            <span style={{color: 'white', fontSize: '3.5vh',}}>
                                                A medical web application, to diagnose retina oct images again 3 abnormalitites.
                                            </span>
                                        </div>
                                    </Col>
                                </Row>
                                ...
                                <Row className="banner-buttons" gutter={[15, 20]}>
                                    <Col span={12}>
                                        <div style={{float: 'right'}}>
                                            <Button type="primary" size="large" onClick={() => this.showModal()} style={{background: 'rgb(0, 232, 185)', boxShadow: '0 0 10px rgb(0, 232, 185)', border: 'None', color: 'black'}}>
